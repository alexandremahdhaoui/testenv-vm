...
// Package main implements the libvirt provider MCP server binary.
// This provider manages VMs, networks, and SSH keys through the libvirt API.
package main
...
import (
	...
	"github.com/alexandremahdhaoui/testenv-vm/internal/providers/libvirt"
)
...
func main() {
	...
	if *versionFlag {
		fmt.Printf("testenv-vm-provider-libvirt %s (commit: %s, built: %s)\n", Version, CommitSHA, BuildTimestamp)
		os.Exit(0)
	}

	if !*mcpFlag {
		fmt.Fprintln(os.Stderr, "This binary must be run with --mcp flag")
		fmt.Fprintln(os.Stderr, "Usage: testenv-vm-provider-libvirt --mcp")
		os.Exit(1)
	}
...
// runMCPServer starts the libvirt provider MCP server with stdio transport.
func runMCPServer() error {
	...
	log.Printf("Starting testenv-vm-provider-libvirt MCP server (version: %s)", Version)
...
func makeCapabilitiesHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, EmptyInput) (*mcp.CallToolResult, any, error) {
...
func makeKeyCreateHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.KeyCreateRequest) (*mcp.CallToolResult, any, error) {
...
func makeKeyGetHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.GetRequest) (*mcp.CallToolResult, any, error) {
...
func makeKeyListHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.ListRequest) (*mcp.CallToolResult, any, error) {
...
func makeKeyDeleteHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.DeleteRequest) (*mcp.CallToolResult, any, error) {
...
func makeNetworkCreateHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.NetworkCreateRequest) (*mcp.CallToolResult, any, error) {
...
func makeNetworkGetHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.GetRequest) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, req *mcp.CallToolRequest, input providerv1.GetRequest) (*mcp.CallToolResult, any, error) {
...
func makeNetworkListHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.ListRequest) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, req *mcp.CallToolRequest, input providerv1.ListRequest) (*mcp.CallToolResult, any, error) {
...
func makeNetworkDeleteHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.DeleteRequest) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, req *mcp.CallToolRequest, input providerv1.DeleteRequest) (*mcp.CallToolResult, any, error) {
...
func makeVMCreateHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.VMCreateRequest) (*mcp.CallToolResult, any, error) {
...
func makeVMGetHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.GetRequest) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, req *mcp.CallToolRequest, input providerv1.GetRequest) (*mcp.CallToolResult, any, error) {
...
func makeVMListHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.ListRequest) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, req *mcp.CallToolRequest, input providerv1.ListRequest) (*mcp.CallToolResult, any, error) {
...
func makeVMDeleteHandler(p *libvirt.Provider) func(context.Context, *mcp.CallToolRequest, providerv1.DeleteRequest) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, req *mcp.CallToolRequest, input providerv1.DeleteRequest) (*mcp.CallToolResult, any, error) {
